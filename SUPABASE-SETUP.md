...
# v0.6 — Account & Social upgrade

Run this block **once** in Supabase → SQL Editor after the existing setup. It adds a
unique Trader ID, real friend requests, trader search support and user-initiated account deletion.
...
After running this block, existing referral friendships remain valid. Search-created friendships
and referral-created friendships both feed the same Friends League and Desk Challenge system.
