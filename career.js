...
(() => {
  ...
  const skills = {
    ...
    freight:   { name:'Shipping & Freight', short:'Shipping', icon:'▰', description:'Price transport, vessel economics, laytime and the cover on the goods.' },
    risk:      { name:'Risk & Quantitative Methods', short:'Risk', icon:'△', description:'Measure exposure, concentration, liquidity and tail scenarios, and defend them.' },
    ...
    carbon:    { name:'Sustainability & Ethics', short:'Sustainability', icon:'◈', description:'Price the emissions, traceability and human-rights rules that now sit inside the landed cost.' },
    legal:     { name:'Contracts & Regulation', short:'Contracts', icon:'§', description:'Agree the terms that decide who pays when a trade fails, and enforce them.' },
    structure: { name:'Accounts, Structure & Tax', short:'Accounts', icon:'⌸', description:'Read a trading house’s statements, and know why the margin is booked where it is.' },
    ...
    macro:     { name:'Trade Economics', short:'Economics', icon:'◍', description:'Explain why a flow exists, and what policy and currency do to it.' },
    tech:      { name:'Trading Technology', short:'Technology', icon:'⌘', description:'Run the trade lifecycle in systems, and know where the data can betray you.' },
    options:   { name:'Options', short:'Options', icon:'◑', description:'Buy and sell optionality, and know what the premium is really paying for.' },
    energy:    { name:'Energy Markets', short:'Energy', icon:'⏻', description:'Trade the barrel, the molecule and the electron, and the certificates attached to them.' },
    metals:    { name:'Metals & Minerals', short:'Metals', icon:'Cu', description:'Price ore, concentrate and warrant, from the mine to the smelter.' },
